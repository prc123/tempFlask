...
#  下载视频
def down_video(video_list, title, start_url, page,Path=""):
    num = 1
...
# quality 请输入您要下载视频的清晰度(1080p:80;720p:64;480p:32;360p:16)(填写80或64或32或16):
def downVideos(url,quality):
    global start_time 
    start_time=time.time()
    # 用户输入av号或者视频链接地址
    print('*' * 30 + 'B站视频下载' + '*' * 30)
    start = url
    start_url = f'https://api.bilibili.com/x/web-interface/view?aid={start}'
